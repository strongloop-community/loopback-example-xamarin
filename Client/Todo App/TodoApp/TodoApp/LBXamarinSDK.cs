		...
		*/
        public abstract class CRUDInterface<T> where T : LBModel
        {
			private static readonly Dictionary<string, string> APIDictionary = new Dictionary<string, string>
            {
				...
				{"todotask/prototype$updateattributes", "TodoTasks/:id"}, 
			};
		...
		public class Users : CRUDInterface<User>
		{
			 ...
			 */
			public static async Task<TodoTask> findByIdTodoTask(string id, string fk)
			{
			...
			/*
			 * Delete a related item by id for TodoTask.
			 */
			public static async Task destroyByIdTodoTask(string id, string fk)
			{
				string APIPath = "users/:id/TodoTask/:fk";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
			...
			/*
			 * Update a related item by id for TodoTask.
			 */
			public static async Task<TodoTask> updateByIdTodoTask(TodoTask data, string id, string fk)
			{
				string APIPath = "users/:id/TodoTask/:fk";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
			...
			/*
			 * Queries TodoTask of user.
			 */
			public static async Task<IList<TodoTask>> getTodoTask(string id, string filter = default(string))
			{
				string APIPath = "users/:id/TodoTask";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
				APIPath = APIPath.Replace(":id", (string)id);
			...
			/*
			 * Creates a new instance in TodoTask of this model.
			 */
			public static async Task<TodoTask> createTodoTask(TodoTask data, string id)
			{
				string APIPath = "users/:id/TodoTask";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
			...
			/*
			 * Deletes all TodoTask of this model.
			 */
			public static async Task deleteTodoTask(string id)
			{
				string APIPath = "users/:id/TodoTask";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
			...
			/*
			 * Counts TodoTask of user.
			 */
			public static async Task<double> countTodoTask(string id, string where = default(string))
			{
				string APIPath = "users/:id/TodoTask/count";
				IDictionary<string, string> queryStrings = new Dictionary<string, string>();
				string bodyJSON = "";
				APIPath = APIPath.Replace(":id", (string)id);
...
namespace LBXamarinSDK
{
	...
	public partial class TodoTask : LBModel
	{
		...
		{
			get { return _isFavorite ?? new bool(); }
